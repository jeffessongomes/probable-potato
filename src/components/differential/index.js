  ...
  <ContainerDifferential>
    <Container fluid>
      ...
      <Row>
        ...
        <Col lg={7} sm={12} className="pr-lg-0 pl-0 pr-0 order-1 order-lg-2">
          <img
            className="photoDifferential d-none d-lg-block"
          ...
          />
          <img
            className="photoDifferential d-block d-md-none"
